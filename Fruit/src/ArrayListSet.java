...
public class ArrayListSet<E> implements Set<E>, Cloneable {
	...
	// setting elements of this arraylist to be a new arraylist
	public ArrayListSet(ArrayListSet<E> set) {
	...
	// Can be used for iterating through list / linked lists etc.
	// CHECK OUT ITERATABLE IN JAVA LIBRARY
	public Iterator<E> iterator() {
		return setElements.iterator(); // return iterator over a set
	}
	
	// using the object clone to create a new clone of the array
